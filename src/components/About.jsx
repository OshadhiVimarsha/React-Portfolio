...
const About = () => {
  ...
  // CV path
  const cvPath = "/files/My_CV.pdf"; // public/files/My_CV.pdf
  ...
  const handleCVDownload = () => {
    ...
    document.body.appendChild(link); // append before click
    link.click();
      ...
      <div className="md:container px-5 py-10">
        ...
        <div className="flex flex-col md:flex-row items-center gap-8 mb-16">
          ...
          <div className="md:w-1/2 text-center md:text-left" data-aos="fade-right">
            <h2 className="title text-center">{about.title}</h2>
            <h4 className="subtitle text-center">{about.subtitle}</h4>
            <p className="text-gray-600 leading-relaxed mt-8">{about.description_1}</p>
            <p className="text-gray-600 leading-relaxed mt-4">{about.description_2}</p>
