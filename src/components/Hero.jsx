...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <div className="min-h-screen relative flex md:flex-row flex-col-reverse md:items-center justify-center items-center px-6">
        {/* left column */}
        <div className="pb-16 pt-10 text-center" data-aos="fade-down">
          ...
          <p className="text-gray-700 dark:text-gray-300 text-base md:text-lg leading-relaxed mt-4">
            This is my official portfolio website to show all details and work experience <br /> 
            in web development. I excel at crafting elegant digital experiences.
          </p>
