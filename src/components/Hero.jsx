      ...
      >
        <defs>
          <linearGradient id="triGrad" x1="0" y1="0" x2="1" y2="1">
            <stop offset="0%" stopColor="#17d2eaff" stopOpacity="0.12" />
            <stop offset="100%" stopColor="#04a4c4ff" stopOpacity="0.22" />
          </linearGradient>
        </defs>
        ...
        <div className="pb-16 pt-10" data-aos="fade-down">
          ...
          <div className="flex justify-start mt-6 py-2">
            <button className="relative overflow-hidden px-6 py-3 font-medium text-white rounded-xl bg-white dark:bg-indigo-500 group">
              ...
              {/* Shadow Effect */}
              <span className="absolute inset-0 shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-xl"></span>
            </button>
          </div>
          ...
          <div className="flex items-center gap-4 mt-4 py-3">
            ...
            >
              <svg width="22" height="22" viewBox="0 0 48 48" fill="none">
                <path fill="#FFC107" d="M43.6 20.5H42V20H24v8h11.3C33.7 32.9 29.3 36 24 36 16.8 36 11 30.2 11 23S16.8 10 24 10c3.4 0 6.5 1.3 8.9 3.4l5.6-5.6C34.8 4.5 29.7 2 24 2 11.8 2 2 11.8 2 24s9.8 22 22 22c11 0 21-8 21-22 0-1.2-.1-2.4-.4-3.5z"/>
                <path fill="#FF3D00" d="M6.3 14.7l6.6 4.8C14.6 16.1 18.9 14 24 14c3.4 0 6.5 1.3 8.9 3.4l5.6-5.6C34.8 4.5 29.7 2 24 2 16 2 9 6.2 6.3 14.7z"/>
                <path fill="#4CAF50" d="M24 46c5.1 0 9.9-1.9 13.5-5.1l-5.9-4.9C29.4 37.8 26.9 39 24 39c-5.2 0-9.6-3.1-11.4-7.6l-6.5 5C9 41.8 16 46 24 46z"/>
                <path fill="#1976D2" d="M43.6 20.5H42V20H24v8h11.3c-1.3 3.8-4.8 6-9.3 6-5.2 0-9.6-3.1-11.4-7.6l-6.5 5C9 41.8 16 46 24 46c11 0 21-8 21-22 0-1.2-.1-2.4-.4-3.5z"/>
              </svg>
            </a>
            {/* Facebook */}
            <a
            ...
            >
              <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor" className="text-[#0866FF]">
                <path d="M22 12.07C22 6.48 17.52 2 11.93 2S2 6.48 2 12.07C2 17.06 5.66 21.2 10.44 22v-7.02H7.9V12h2.54v-2.3c0-2.5 1.49-3.88 3.77-3.88 1.09 0 2.23.2 2.23.2v2.45h-1.26c-1.24 0-1.63.77-1.63 1.56V12h2.78l-.44 2.98h-2.34V22C18.34 21.2 22 17.06 22 12.07z"/>
              </svg>
            </a>
            {/* LinkedIn */}
            <a
            ...
            >
              <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor" className="text-[#0A66C2]">
                <path d="M4.98 3.5C4.98 4.88 3.86 6 2.5 6S0 4.88 0 3.5 1.12 1 2.5 1s2.48 1.12 2.48 2.5zM.5 8.5h4V24h-4V8.5zM8.5 8.5h3.8v2.1h.1c.5-.9 1.7-2.2 3.6-2.2 3.9 0 4.6 2.6 4.6 6V24h-4v-7.2c0-1.7 0-3.8-2.3-3.8s-2.6 1.8-2.6 3.7V24h-4V8.5z"/>
              </svg>
            </a>
            {/* GitHub */}
            <a
